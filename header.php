...
<head>
	...
	<link rel='stylesheet' id='compiled-css'  href='<?= get_stylesheet_directory_uri() ?>/compiled.css' media='all' />
	<script src="https://code.jquery.com/jquery-3.6.0.min.js" defer></script>
	<script src='<?= get_stylesheet_directory_uri() ?>/assets/js/custom.js' defer></script>
